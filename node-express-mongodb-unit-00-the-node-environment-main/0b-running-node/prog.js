...
// 1. Create a console.log that logs the message "Hello World!" to the console.
const fullName = "Wacine The Great";
...
function greetUser(name) {
    ...
    if (names.length > 1) {
        ...
        return "Please give the user's full name"
    }   
}

const message = greetUser('wendy');
console.log(message);
...
// You should see "Hello World!" printed out in the terminal. Well done! You've run your first Node.js program.
